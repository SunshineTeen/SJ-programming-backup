...
#define BLACK_BLOCK 0*16+7
#define WHITE_BLOCK 7*16+7
...
// ビットマップ描画時マージン
#define QR_MARGIN	     4
#define Finder_MARGIN    7
#define Alignment_MARGIN 5
#define Alignment_Common 6

//区分是否填过
#define fun_Black  0x1
#define fun_White  0x2
#define Retain     0x4
#define data_Black 0xB
#define data_White 0xA
...
//***************************************
void encode_data(const int ver, const char *const s, const int len, unsigned char *encode_data, int &databit);
